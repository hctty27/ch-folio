...
{
    const localPosition = new Vector3(0.22, 0.65, 0)
...
test('physical fallback moves forward while retaining centered eye height', () =>
{
    closeTo(DEFAULT_PHYSICAL_COCKPIT_POSITION.x, 0.22)
    closeTo(DEFAULT_PHYSICAL_COCKPIT_POSITION.y, 0.65)
